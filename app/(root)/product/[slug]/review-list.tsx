...
// Define the form type explicitly from the schema
type CustomerReview = z.infer<typeof ReviewInputSchema>

// Remove this since we're inlining the default values
// const reviewFormDefaultValues: Partial<CustomerReview> = {
//   title: '',
//   comment: '',
//   rating: 1, // Changed to 1 since schema requires min 1
// }
...
export default function ReviewList({
  ...
  // Use the explicit type here - most compatible approach
  const form = useForm({
                          ...
                          <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                <Select
                                  onValueChange={field.onChange} // Remove Number() conversion since z.coerce handles it
